...
| **08** 🆕 | [**把 ChatGPT Image 2.0 裝進 Claude Code**](08-安裝gpt-image-2生圖.md) | **EP11** | **v0.1** | **🆕 全域 `draw` Skill 安裝：OpenAI API Key + Individual 驗證 + `~/.claude/skills/draw/` + 第一張圖驗證。之後在任何專案對 Claude 說「畫一張 XX」就生圖；費用以 OpenAI 官方 pricing 為準** |
